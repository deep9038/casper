  ...
  return (
    ...
    <div className='foot-inn'>
      ...
      <div className='fbox box2'>
        <h1>GET IN TOUCH</h1>
        <h4><i className="fa-solid fa-envelope" style={{marginRight:"10px",marginTop:"15px"}}></i> CodeCaspr96@gmail.com</h4>
      ...
      <h3 style={{textAlign:"center",marginTop:"30px",position:"relative",zIndex:"2"}} className="cradit">Created and Crafted by &copy; Codecasper Technologies Pvt.Ltd</h3>
